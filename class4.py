...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.search_buuton = QtWidgets.QPushButton(self.centralwidget)
        self.search_buuton.setGeometry(QtCore.QRect(770, 0, 121, 41))
        self.search_buuton.setObjectName("search_buuton")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.search_buuton.setText(_translate("MainWindow", "Искать"))
